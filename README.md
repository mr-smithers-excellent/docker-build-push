...
It is strongly recommended that you store all Docker credentials as GitHub [encrypted secrets](https://docs.github.com/en/actions/security-guides/encrypted-secrets). Secrets can be access in GitHub Actions workflows using the syntax `${{ secrets.SECRET_NAME }}`.
